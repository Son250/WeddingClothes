...
<!-- Mirrored from www.madebydesignesia.com/themes/rentaly/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jan 2024 04:24:56 GMT -->
...
<head>
    ...
    <!-- CSS Files
    ================================================== -->
    <link href="../assets/css-view/bootstrap.min.css" rel="stylesheet" type="text/css" id="bootstrap">
    <link href="../assets/css-view/mdb.min.css" rel="stylesheet" type="text/css" id="mdb">
    <link href="../assets/css-view/plugins.css" rel="stylesheet" type="text/css">
    <link href="../assets/css-view/style.css" rel="stylesheet" type="text/css">
    <link href="../assets/css-view/coloring.css" rel="stylesheet" type="text/css">
    <!-- color scheme -->
                ...
                <div class="container">
                    <div class="topbar-left xs-hide">
                        <div class="topbar-widget">
                            <div class="topbar-widget"><a href="#" class=""><i class="fa fa-phone text-white"></i>0973657594</a></div>
                            <div class="topbar-widget"><a href="#" class=""><i class="fa fa-envelope text-white"></i>weddingClothes123@gmail.com</a></div>
                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                <ul id="mainmenu">
                                    ...
                                    <li><a class="menu-item" href="cars.html">Quần áo cưới</a>
                                        <ul>
                                            <li><a class="menu-item" href="cars.html">Cars List 1</a></li>
                                            <li><a class="menu-item" href="02_dark-cars.html">Cars List 1 Dark</a></li>
                                            <li><a class="menu-item" href="cars-list.html">Cars List 2</a></li>
                                    ...
                                    <li><a class="menu-item" href="account-dashboard.html">Tài khoản</a>
                                        <ul>
                                    ...
                                    <li><a class="menu-item" href="#">Tin tức</a>
                                        <ul>
