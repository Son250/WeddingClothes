...
<div class="no-bottom no-top" id="content">
                ...
                <div id="items-carousel" class="owl-carousel wow fadeIn">
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/jeep-renegade.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>Jeep Renegade</h4>
                                    ...
                                    <div class="d-atr-group">
                                        <span class="d-atr"><img src="../assets/images-view/icons/1-green.svg" alt="">5</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/2-green.svg" alt="">2</span>
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/bmw-m5.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>BMW M2</h4>
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="../assets/images-view/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/4-green.svg" alt="">Sedan</span>
                                    </div>
                                    <div class="d-price">
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/ferrari-enzo.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>Ferarri Enzo</h4>
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="../assets/images-view/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/4-green.svg" alt="">Exotic Car</span>
                                    </div>
                                    <div class="d-price">
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/ford-raptor.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>Ford Raptor</h4>
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="../assets/images-view/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/4-green.svg" alt="">Truck</span>
                                    </div>
                                    <div class="d-price">
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/mini-cooper.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>Mini Cooper</h4>
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="../assets/images-view/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="../assets/images-view/icons/4-green.svg" alt="">Hatchback</span>
                                    </div>
                                    <div class="d-price">
                    ...
                    <div class="col-lg-12">
                        <div class="de-item mb30">
                            <div class="d-img">
                                <img src="../assets/images-view/cars/vw-polo.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="d-info">
                                <div class="d-text">
                                    <h4>VW Polo</h4>
    ...
    <section id="section-img-with-tab" data-bgcolor="#f8f8f8">
        ...
        <div class="image-container col-md-6 pull-right" data-bgimage="url(../assets/images-view/background/5.jpg) center"></div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="../assets/images-view/testimonial/1.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="../assets/images-view/testimonial/2.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="../assets/images-view/testimonial/3.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                    ...
                    <div class="bloglist s2 item">
                        <div class="post-content">
                            <div class="post-image">
                                ...
                                <img alt="" src="../assets/images-view/news/pic-blog-1.jpg" class="lazy">
                            </div>
                            <div class="post-text">
                    ...
                    <div class="bloglist s2 item">
                        <div class="post-content">
                            <div class="post-image">
                                ...
                                <img alt="" src="../assets/images-view/news/pic-blog-2.jpg" class="lazy">
                            </div>
                            <div class="post-text">
                    ...
                    <div class="bloglist s2 item">
                        <div class="post-content">
                            <div class="post-image">
                                ...
                                <img alt="" src="../assets/images-view/news/pic-blog-3.jpg" class="lazy">
                            </div>
                            <div class="post-text">
